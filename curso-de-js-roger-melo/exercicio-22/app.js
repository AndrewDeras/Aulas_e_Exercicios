...
const onlyDisneyMovies = topBrazilMovies.filter(({ distributedBy }) => distributedBy === 'Disney');
let amountDisneyViewers = 0;

onlyDisneyMovies.forEach(({ peopleAmount }) => {
  amountDisneyViewers += peopleAmount
  return amountDisneyViewers
})

console.log(amountDisneyViewers);
...
console.log(pets, dogsInHumanAge);
/*
