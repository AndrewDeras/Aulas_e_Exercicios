...
let cat = {
  ...
  age: 5,
  color: 'laranja',
  bestFriends: ['Tommy', 'Jerry'],
  sound: () => console.log('Miado do gato')
}
...
const isAnObject = (value) => console.log(typeof value === "object");;
...
let dog = {
  ...
  age: 7,
  color: 'Marrom',
  bestFriends: ['Antonio', 'Maria'],
  sound: () => console.log('Latido do cachorro')
};
...
let cars = {
  modeloSuv: ['Honda HR-V', 'Jeep Renegade', 'Ford EcoSport', 'Hyundai iX35']
}

const isAnSUV = car => {
  if (cars.modeloSuv.includes(car)) {
    return true
  }
