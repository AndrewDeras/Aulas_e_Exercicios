...
const lastWord = firstFourStrings[firstFourStrings.length - 1];
const fourString = firstFourStrings.join(', ').replace(`, ${lastWord}`, ` e ${firstFourStrings[firstFourStrings.length - 1]}`);
...
switch (number) {
  ...
  case 1:
    ...
    break;
  default:
    message = `${numberMessage} qualquer número, exceto 0 e 1.`
};
