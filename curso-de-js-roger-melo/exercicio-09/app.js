...
const numberOfChar = string => string.length;

console.log(numberOfChar('Andrew Barbosa Deras'));
...
const indexOfString = (string, char) => {
  console.log(string.indexOf(char));
}

indexOfString('Andrew', 'w')
*/
/*
  05
...
let animals = ['Leão', 'Frango', 'Peixe', 'Pássaro'];

const verifyItem = (array, item)=> {
  return array.includes(item);
}
console.log(verifyItem(animals, 'Peixe'));
*/
/*
  06
...
let numbers6To9 = [6, 7, 8, 9];

const concatArrays = (array1, array2)=> {
  return array1.concat(array2);
}

console.log(concatArrays(numbers1To5, numbers6To9));
*/
/*
  07
...
const first6LettersOfAlphabet = ['a', 'b', 'c', 'd', 'e', 'f'];

const removeLastItem = array => {
  array.pop();
  return array;
}
removeLastItem(first6LettersOfAlphabet)
...
const verifyValue = value =>  value === null;

console.log(verifyValue('null'));
*/
...
const tripleOfAnNumber = (number) => number * 3;

console.log(callCallBack(33, tripleOfAnNumber));
*/
/*
  11
...
const getLikesMessages = (names = []) => {
  const firstName = names[0];
  const secondtName = names[1];
  ...
  switch (names.length) {
    ...
    case 2:
      return `${firstName} e ${secondtName} curtiram isso`;
    case 3:
      return `${firstName}, ${secondtName} e ${thirdName} curtiram isso`;
    default:
      return `${firstName}, ${secondtName} e mais ${totalNamesMinusTwo} pessoas curtiram isso`;
  }
}

console.log(getLikesMessages(['Andrew', 'Lindsay', 'Maria', 'Jeffrey', 'Alexandre']));